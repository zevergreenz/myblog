...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="http://localhost/myblog/static/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="http://localhost/myblog/static/css/blog-home.css" rel="stylesheet">
            ...
            <div class="col-md-9">
                ...
                <?php 
                    if (!empty($_SESSION['username'])) {
                        echo '       
                        <form class="form-signin" action="http://localhost/myblog/model/post.php" method="POST">
				...
				<div class="account-wall">
                    <?php 
                        if (!empty($_SESSION['username'])) {
                            ...
                            echo '<p>You are not logged in </p>
                            <h4>Log in: </h4>
                            <form class="form-signin" action="http://localhost/myblog/model/login.php" method="POST">
